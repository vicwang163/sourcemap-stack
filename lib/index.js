...
exports.getRealStack = exports.getMapPath = exports.getStackByError = undefined;

var _getStackByError = __webpack_require__(40);

Object.defineProperty(exports, 'getStackByError', {
  enumerable: true,
  get: function get() {
    return _getStackByError.getStackByError;
  }
});

var _getMapPath = __webpack_require__(41);

Object.defineProperty(exports, 'getMapPath', {
  enumerable: true,
  get: function get() {
    return _getMapPath.getMapPath;
  }
});

var _mappingRealPath = __webpack_require__(42);

Object.defineProperty(exports, 'getRealStack', {
  enumerable: true,
  get: function get() {
    return _mappingRealPath.getRealStack;
  }
});

var _vlq = __webpack_require__(38);
...
exports.getStackByError = getStackByError;
var path = __webpack_require__(21);
/*
* 转换error stack为数组，用于分析sourcemap
*/
function getStackByError(str) {
  var result = [];
  str.replace(/\((.*?)\)/g, function (all, value) {
    result.push(value);
  });
  result = result.map(function (item) {
    var arr = path.basename(item).split(':');
    var column = arr.pop();
    var row = arr.pop();
    var filepath = path.dirname(item) + '/' + arr.join('');
    var html = !/\.js$/.test(filepath);
    return { filepath: filepath, row: row, column: column, html: html };
  });
  if (!result.length) {
    result = null;
  }
...
function getMapPath(stacks, params) {
  for (var i = 0; i < stacks.length; i++) {
    ...
    var basename = path.basename(stack.filepath);
    var dirname = path.dirname(stack.filepath);
...
exports.getRealStack = undefined;
...
* @param {Array} stacks
*/
var getRealStack = exports.getRealStack = function () {
  var _ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee(stacks, params) {
    var result, setmap, encrypter, i, stack, content, rt, mapResult;
    return _regenerator2.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            result = [];
            setmap = (0, _create2.default)(null);
            encrypter = null;
          ...
          case 5:
            ...
            _context.next = 10;
            return getContent(stack.filepath);

          case 10:
            stack['content'] = _context.sent;

            result.push(stack);
            return _context.abrupt('continue', 34);

          case 13:
            content = setmap[stack.mapUrl];
            ...
            _context.next = 17;
            return getContent(stack.mapUrl);
          ...
          case 32:
            // 查找堆栈
            mapResult = mapErrorPosition(content, stack.row, stack.column);
  ...
  return function getRealStack(_x, _x2) {
        ...
        switch (_context2.prev = _context2.next) {
          case 0:
            return _context2.abrupt('return', new _promise2.default(function (resolve) {
              var get = /^https/.test(filepath) ? https.get : http.get;
              var options = parseUrl(filepath);
...
var vlq = __webpack_require__(38);
var Encrypter = __webpack_require__(86);function mapErrorPosition(content, row, column) {
  var mapResult = content[row] && content[row][column] || null;
  if (!mapResult) {
    var columns = content[row];
    if (!columns) {
      return null;
    }
    // 进行修正
...
function mappingSingleFile(object) {
  var mappings = object.mappings;
  var lines = mappings.split(';');
  var result = {};
  var tempResult = void 0;
  // 转码后的列
  var transformedColumn = 1;
  // 文件索引
  var sourceIndex = 0;
  // 文件row
  var sourceRow = 1;
